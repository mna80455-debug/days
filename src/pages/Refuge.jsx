...
const SOOTHING_CARDS = [
  "تنفسي بعمق، أنتِ بأمان في هذه اللحظة، والضيق الذي تشعرين به سيمر ويعبر كما عبر غيره.",
  "ليس عليكِ التفكير في كل شيء الآن. ركّزي فقط على النفس الحالي، دقة واحدة في كل مرة.",
  "قلبكِ قوي بما يكفي لتجاوز هذه الغيمة المزعجة. خذي وقتكِ بالكامل، لا أحد يستعجلكِ.",
  "الأفكار هي مجرد سحب عابرة في سماء وعيكِ، أنتِ السماء الثابتة وليست الغيوم المتحركة.",
  "رفقاً بنفسكِ يا صديقتي. ما تشعرين به الآن هو مجرد إشارة لجسدكِ كي يبطئ ويرتاح.",
  "أنتِ أكبر من مخاوفكِ. دعي هذا القلق يتدفق خارج جسدكِ مع كل زفير يخرج منكِ الآن."
];
...
const Refuge = () => {
  ...
  const groundingStepsData = [
    { title: "👀 حددي 5 أشياء ترينها حولكِ الآن", desc: "انظري حول الغرفة أو المكان، وركزي بصركِ على خمسة أشياء مختلفة (مثلاً: كوب، شجرة، قلم، نافذة، مقعد)." },
    { title: "✋ حددي 4 أشياء تلمسينها الآن", desc: "اشعري بملمس أربعة أشياء قريبة منكِ (مثلاً: ملمس ملابسكِ، ملمس السطح الخشبي، برودة هاتفكِ، نعومة السجادة)." },
    { title: "👂 حددي 3 أصوات تسمعينها الآن", desc: "أنصتي بتركيز للأصوات الخارجية من حولكِ (مثلاً: صوت مكيف الهواء، زقزقة طيور بالخارج، حركة السيارات البعيدة)." },
    { title: "👃 حددي شيئين تشمين رائحتهما الآن", desc: "حاولي ملاحظة الروائح المحيطة بكِ (مثلاً: رائحة قهوتكِ، عطر ملابسكِ، أو رائحة الهواء الخارجي)." },
    { title: "👅 حددي شيئاً واحداً يمكنكِ تذوقه الآن", desc: "ركزي على الطعم في فمكِ أو خذي رشفة ماء، واشعري بنكهتها بوعي تام." }
  ];
  ...
  return (
    <div className="page-content" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <header className="page-header animate-in animate-in-delay-1">
        ...
        <h1>الملجأ السريع لتنظيم مشاعركِ</h1>
        <p>إذا كنتِ تشعرين بالتوتر، الضغط، أو القلق الشديد، خذي نفساً وجربي أحد التمارين المهدئة بالأسفل.</p>
      </header>
      ...
      {activeTab === 'first_aid' && (
        <div className="flex flex-col gap-lg w-full">
          ...
          <div className="card animate-in">
            ...
            <p className="text-sm text-muted mb-md">تمرين نفساني لربط وعيكِ باللحظة الحالية والتخفيف من تشتت القلق.</p>

            {groundingStep === 0 ? (
              <div className="text-center p-md">
                <p className="text-md font-bold mb-md">هل أنتِ مستعدة لإعادة تركيز انتباهكِ وتهدئة وعيكِ؟</p>
                <button 
