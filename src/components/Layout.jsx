    ...
    const checkAndShowReminder = () => {
      ...
      if (savedSettings) {
        ...
        if (parsed.mindfulRemindersEnabled && 'Notification' in window && Notification.permission === 'granted') {
          const prompts = [
            "خذ نفساً عميقاً الآن... زفير طويل 🌸",
            "كيف حال ظهرك وكتفيك الآن؟ أرخِ عضلاتك برفق 🌿",
            "هل شربت كوب ماء في الساعات الأخيرة؟ ترطيب جسدك مهم 💧",
            "توقف لدقيقة واحدة واستشعر اللحظة الحالية بكل حضور 🙏",
            "أنت تبذل جهداً رائعاً. رفقاً بنفسك وخذ استراحة وعي قصيرة ✨"
          ];
